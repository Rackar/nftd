...
let web3instance ={
  web3:null,account:null,chainId:null,dnftContract:null,nftContract:null,dloliContract:null
}
...
function getUnloginWeb3Instance() {
    ...
    return{web3,account:null,chainId:null,dnftContract,nftContract,dloliContract}
}

export { requestLoginMetaMask,init,web3instance,address_DNFT,ABI_DNFT,address_NFT,ABI_NFT,address_DLOLI,ABI_DLOLI}