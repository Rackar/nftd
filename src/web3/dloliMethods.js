...
//判断是否领取过
 function accountToFetched(address_User) {
    return new Promise((resolve, reject) => {
        web3instance.dloliContract.methods.accountToFetched(address_User).call().then(function (result) {
 ...
 function fetchLOLI() {
    return new Promise((resolve, reject) => {
        web3instance.dloliContract.methods.fetchLOLI().send().then(function (result) {
